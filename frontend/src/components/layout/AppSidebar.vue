...
// Admins can access the workbench for configuration/testing even when the
// public user-facing image feature is disabled.
const flagImageWorkbench = () => authStore.isAdmin || appStore.cachedPublicSettings?.dedicated_image_enabled === true
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  if (!isAdmin.value) {
	...
	items.push(
		...
		{ path: '/image-workbench', label: t('nav.imageWorkbench'), icon: BatchImageIcon, hideInSimpleMode: true, featureFlag: flagImageWorkbench },
		{ path: '/batch-image', label: t('nav.batchImage'), icon: BatchImageIcon, hideInSimpleMode: true, featureFlag: flagBatchImageAccess },
    { path: '/usage', label: t('nav.usage'), icon: ChartIcon, hideInSimpleMode: true },
    { path: '/available-channels', label: t('nav.availableChannels'), icon: ChannelIcon, hideInSimpleMode: true, featureFlag: flagAvailableChannels },
    { path: '/monitor', label: t('nav.channelStatus'), icon: SignalIcon, featureFlag: flagChannelMonitor },
    { path: '/subscriptions', label: t('nav.mySubscriptions'), icon: CreditCardIcon, hideInSimpleMode: true },
    { path: '/purchase', label: t('nav.onlineRecharge'), icon: RechargeSubscriptionIcon, hideInSimpleMode: true, featureFlag: flagPayment },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/campaigns/newcomer', label: t('nav.newcomerCampaign'), icon: GiftIcon, hideInSimpleMode: true },
    {
