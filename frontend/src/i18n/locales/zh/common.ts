export default {
  ...
  auth: {
    ...
    codeSentSuccess: '验证码已发送！若未收到邮件请查看垃圾箱',
    verifying: '验证中...',
    ...
    resetPasswordHint: '为账户创建一个新的安全密码',
    resetLinkExpiredQuestion: '链接已失效？',
    resendResetLink: '重新发送',
    newPassword: '新密码',
