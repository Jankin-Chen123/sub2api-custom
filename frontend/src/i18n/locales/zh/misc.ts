export default {
  ...
  campaign: {
    ...
    tierUpgradeRemaining: '还需 {count} 个有效邀请，升级为{tier}会员',
    ...
    membershipExclusiveRate: '享受原倍率 {percent}% 的专属倍率',
  ...
  userSubscriptions: {
    ...
    balanceProtected: '余额支付安全可靠',
    currentSubscription: '当前订阅',
    manage: '管理订阅',
    manageTitle: '已购买的订阅',
    manageHint: '同一时间只能启用一张订阅卡',
    manageEmpty: '暂无可管理的订阅卡',
    current: '当前使用中',
    remaining: '有效期剩余',
    quota: '额度',
    billingPeriod: '选择计费周期',
    month: '月付',
    week: '周',
    quarter: '季付',
    year: '年付',
    ...
    yearDiscount: '省20%',
    recommended: '推荐',
    planDescriptionFallback: '灵活的订阅方案，满足日常使用需求',
    noActiveSubscriptions: '暂无有效订阅',
    noActiveSubscriptionsDesc: '您没有任何有效订阅。请打开“管理订阅”查看待启用的订阅卡。',
    noPurchasedSubscriptionsDesc: '购买后，请在“管理订阅”中查看并手动启用订阅卡。',
    failedToLoad: '加载订阅失败',
    ...
    accountBalance: '账户余额',
    amountDue: '需支付金额',
    purchaseSuccess: '订阅卡购买成功，请在“管理订阅”中手动启用。',
    purchaseFailed: '购买订阅失败，请检查余额或稍后重试。',
    activate: '立即启用',
    activateAfterExpiry: '等待失效后启用',
    activateBlocked: '当前已有生效订阅，请等待其失效后再启用此卡。',
    ...
    benefitsTitle: '订阅服务保障',
    quickStart: '灵活启用',
    quickStartDesc: '购买后可选择启用时间',
    securePayment: '安全可靠',
    securePaymentDesc: '多重加密，保障安全',
    cancelAnytime: '随时取消',
    cancelAnytimeDesc: '到期自动关闭，不扣费',
    support: '专属客服',
    supportDesc: '工单与在线客服支持'
  },
  ...
  payment: {
    ...
    admin: {
      ...
      groupId: '分组 ID',
      features: '功能特性',
      featuresHint: '每条权益单独填写，可添加、删除和调整顺序',
      featuresItemPlaceholder: '输入这一条权益，例如：卡密兑换：支持',
      featuresItemLabel: '第 {index} 条权益',
      featuresAdd: '添加权益',
      featuresRemove: '删除第 {index} 条权益',
      featuresMoveUp: '上移',
      featuresMoveDown: '下移',
      featuresEmpty: '暂未配置额外权益，点击“添加权益”开始配置',
