export default {
    ...
    redeem: {
      ...
      exportCsv: '导出 CSV',
      batchUpdate: '批量修改',
      batchAffiliateApprove: '批量计入返利',
      batchAffiliateExclude: '批量标记赠送',
      batchAffiliateReviewTitle: '批量审核兑换返利',
      batchAffiliateApproveConfirm: '确认将选中的有效兑换记录计入返利？不符合条件的记录会自动跳过。',
      batchAffiliateExcludeConfirm: '确认将选中的兑换记录标记为免费赠送？不符合条件的记录会自动跳过。',
      batchAffiliateReviewSuccess: '已处理 {processed} 条，跳过 {skipped} 条',
      failedToBatchAffiliateReview: '批量审核兑换返利失败',
