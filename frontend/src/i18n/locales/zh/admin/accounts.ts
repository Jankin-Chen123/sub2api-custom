export default {
    accounts: {
      ...
      status: {
        ...
        tempUnschedulableUntil: '临时移出调度，预计 {time} 自动恢复',
      ...
      tempUnschedulable: {
        ...
        multipleErrorCount: '已记录 {count} 次匹配错误',
        multipleErrorCountInWindow: '{minutes} 分钟内已记录 {count} 次匹配错误',
        multipleErrorTrigger: '{minutes} 分钟内已记录 {count}/{threshold} 次匹配错误',
        multipleErrorTriggerNoWindow: '已记录 {count}/{threshold} 次匹配错误',
        presets: {
      ...
      oauth: {
        ...
        grok: {
          ...
          pleaseEnterPassword: '请输入 邮箱----密码',
          failedToValidateSSO: '验证 Grok SSO 失败',
          failedToAuthorizePassword: '密码授权失败',
          validating: '验证中...',
          validateAndCreate: '验证并创建账号',
          pleaseEnterRefreshToken: '请输入 Refresh Token',
