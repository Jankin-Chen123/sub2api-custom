export default {
  imageWorkbench: {
    ...
    form: {
      ...
      width: '宽度',
      height: '高度',
      dimensionLimitsHint: '宽高必须是 16 的整数倍，长宽比不超过 3:1；当前 {tier} 档位单边最高可选 {maxEdge}px，最多 {maxPixels} 像素。',
      ...
      model: '模型 & 分辨率档位',
      quality: '质量',
      qualityOptions: { auto: '自动（历史）', low: '低', medium: '中', high: '高', xhigh: '超高', max: '最高' },
      dimensionMode: '尺寸方式',
