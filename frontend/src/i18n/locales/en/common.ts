export default {
  ...
  auth: {
    ...
    backHome: 'Back home',
    welcomeBack: 'Get Started',
    signInToAccount: 'Enter your account details to open the console',
    signIn: 'Sign In',
    ...
    resetPasswordHint: 'Create a new secure password for your account',
    resetLinkExpiredQuestion: 'Has the link expired?',
    resendResetLink: 'Send again',
