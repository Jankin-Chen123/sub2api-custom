export default {
  ...
  campaign: {
    ...
    tierUpgradeRemaining: '{count} more valid invitation(s) to upgrade to {tier} membership',
    ...
    membershipExclusiveRate: 'Exclusive rate at {percent}% of the original multiplier',
  ...
  userSubscriptions: {
    ...
    balanceProtected: 'Secure balance payments',
    currentSubscription: 'Current Subscription',
    manage: 'Manage subscriptions',
    manageTitle: 'Purchased subscriptions',
    manageHint: 'Only one subscription card can be active at a time.',
    manageEmpty: 'No subscriptions to manage.',
    current: 'Currently active',
    remaining: 'Time remaining',
    quota: 'Quota',
    billingPeriod: 'Choose billing period',
    month: 'Monthly',
    week: 'Weekly',
    quarter: 'Quarterly',
    year: 'Yearly',
    quarterDiscount: 'Save 10%',
    yearDiscount: 'Save 20%',
    recommended: 'Recommended',
    planDescriptionFallback: 'A flexible plan for your everyday workflow',
    noActiveSubscriptions: 'No Active Subscriptions',
    noActiveSubscriptionsDesc:
      "You don't have any active subscriptions. Open “Manage subscriptions” to view cards waiting for activation.",
    noPurchasedSubscriptionsDesc: 'Purchased cards can be viewed and activated manually from “Manage subscriptions.”',
    ...
    purchaseSuccess: 'Subscription card purchased. Activate it from “Manage subscriptions” when ready.',
    purchaseFailed: 'Failed to purchase subscription. Check your balance and try again.',
    activate: 'Activate Now',
    activateAfterExpiry: 'Wait for expiry',
    activateBlocked: 'Another subscription is active. Wait for it to expire before activating this card.',
    activateSuccess: 'Subscription activated. Its validity period starts now.',
    activateFailed: 'Failed to activate subscription. Please try again.',
    ...
    usage: 'Usage',
    usageDesc: 'Review the quota usage for your current subscriptions',
    expires: 'Expires',
    ...
    quickStart: 'Flexible activation',
    quickStartDesc: 'Choose when to start your subscription',
    securePayment: 'Secure checkout',
    securePaymentDesc: 'Encrypted and protected',
    cancelAnytime: 'Flexible renewal',
    cancelAnytimeDesc: 'No charge after expiry',
    support: 'Dedicated support',
    supportDesc: 'Tickets and live support'
  },
  ...
  payment: {
    ...
    admin: {
      ...
      groupId: 'Group ID',
      features: 'Features',
      featuresHint: 'Edit each benefit separately. You can add, remove, or reorder items.',
      featuresItemPlaceholder: 'Enter one benefit, e.g. Redemption supported',
      featuresItemLabel: 'Benefit {index}',
      featuresAdd: 'Add benefit',
      featuresRemove: 'Remove benefit {index}',
      featuresMoveUp: 'Move up',
      featuresMoveDown: 'Move down',
      featuresEmpty: 'No extra benefits yet. Add one to configure the card.',
      ...
      quotaOverride: 'Plan quota overrides',
      quotaOverrideHint: 'Values above 0 override group defaults; 0 keeps the group configuration.',
      unlimited: 'Unlimited',
