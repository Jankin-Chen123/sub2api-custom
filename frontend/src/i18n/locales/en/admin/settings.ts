export default {
    settings: {
      ...
      imageGenerationQueue: {
        title: 'Image Generation Queue Protection',
        description: 'Limit image tasks executing at the same time. Excess jobs stay in a persistent queue so smaller servers do not run out of resources during concurrent generation.',
        enabled: 'Enable image queue protection',
        enabledHint: 'When disabled, the server-wide image execution limit is bypassed; existing jobs continue processing.',
        maxActiveJobs: 'Maximum active image tasks',
        maxActiveJobsHint: 'A task occupies a slot through upstream submission, polling, storage, and settlement. Start at 1 and increase gradually.',
        maxQueuedJobs: 'Maximum waiting jobs',
      ...
      imageWorkbenchAnnouncements: {
        ...
        interval: 'Scroll interval (seconds)',
        intervalHint: 'The time before moving to the next announcement. Range: 1–3600 seconds.',
        add: 'Add announcement',
        empty: 'No announcements added yet.',
      ...
      site: {
        ...
        contactPage: {
          ...
          description: 'Update the group number, channel link, and QR images shown on the contact page. Changes take effect after saving without rebuilding the frontend.',
          qqExpiryWarning: 'QQ group QR codes normally expire. Upload the latest image here when needed; the group number remains available as a durable fallback.',
          qqTitle: 'QQ User Group',
          qqGroupNumber: 'QQ Group Number',
          qqGroupNumberPlaceholder: 'e.g., 1097280864',
          qqQrImage: 'QQ Group QR Image',
          telegramTitle: 'Telegram Channel',
          telegramName: 'Channel Name',
          telegramNamePlaceholder: "e.g., {'@'}ai_baipiao",
          telegramUrl: 'Channel URL',
          telegramQrImage: 'Telegram QR Image',
          replaceImage: 'Upload or Replace Image',
          imageHint: 'PNG, JPG, WEBP, or GIF up to 2 MB. The image is stored in database settings.',
        },
      ...
      purchase: {
        title: 'Online Recharge Page',
        description: 'Show an "Online Recharge" entry in the sidebar and open the configured URL in an iframe',
        enabled: 'Show Online Recharge Entry',
        enabledHint: 'Only shown in standard mode (not simple mode)',
        url: 'Online Recharge URL',
