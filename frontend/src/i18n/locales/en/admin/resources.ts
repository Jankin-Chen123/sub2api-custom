export default {
    ...
    redeem: {
      ...
      batchAffiliateApprove: 'Batch Apply Rebates',
      batchAffiliateExclude: 'Batch Mark as Gifts',
      batchAffiliateReviewTitle: 'Batch Review Redeem Rebates',
      batchAffiliateApproveConfirm: 'Apply affiliate rebates to the selected valid redemptions? Ineligible records will be skipped.',
      batchAffiliateExcludeConfirm: 'Mark the selected redemptions as free gifts? Ineligible records will be skipped.',
      batchAffiliateReviewSuccess: 'Processed {processed}, skipped {skipped}',
      failedToBatchAffiliateReview: 'Failed to batch review redeem rebates',
