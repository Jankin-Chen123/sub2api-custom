<template>
  <AuthLayout>
    <div class="auth-form-stack auth-reset-stack">
      ...
      <div v-if="isInvalidLink" class="space-y-6">
        <div class="auth-status-card auth-status-card--warning">
        ...
        <div class="text-center">
          <router-link
            to="/forgot-password"
            class="auth-inline-link inline-flex items-center gap-2"
          >
      ...
      <div v-else-if="isSuccess" class="space-y-6">
        ...
        <div class="text-center">
          <router-link
            to="/login"
            class="btn btn-primary auth-primary-action inline-flex items-center gap-2"
          >
    ...
    <template #footer>
      <p class="auth-footer-copy">
        {{ t('auth.resetLinkExpiredQuestion') }}
