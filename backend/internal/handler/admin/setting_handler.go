...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		ImageGenerationQueueEnabled:                            settings.ImageGenerationQueueEnabled,
		...
		DedicatedImageWorkerEnabled:                            settings.DedicatedImageWorkerEnabled,
		DedicatedImageCodexBridgeEnabled:                       settings.DedicatedImageCodexBridgeEnabled,
		DedicatedImageFallbackToGeneral:                        settings.DedicatedImageFallbackToGeneral,
