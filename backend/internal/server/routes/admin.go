...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/dedicated-image", h.Admin.Ops.GetDedicatedImageMetrics)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/test-image", h.Admin.Account.TestImage)
...
func registerRedeemCodeRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	codes := admin.Group("/redeem-codes")
	{
		...
		codes.POST("/batch-affiliate-review", h.Admin.Redeem.ReviewAffiliateRedeems)
...
func registerCheckinRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	checkin := admin.Group("/check-in")
	{
		...
		checkin.GET("/prizes", h.Admin.Checkin.ListPrizes)
		checkin.PUT("/prizes", h.Admin.Checkin.ReplacePrizes)
	}
}
