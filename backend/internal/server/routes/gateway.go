...
func RegisterGatewayRoutes(
	...
	rootRoute(http.MethodPost, "/images/generations/async", bodyLimit, asyncImagesHandler)
	rootRoute(http.MethodPost, "/images/edits/async", bodyLimit, asyncImagesHandler)
	rootRoute(http.MethodGet, "/images/tasks/:task_id", bodyLimit, imageTaskHandler)
	rootRoute(http.MethodGet, "/images/tasks/:task_id/content", bodyLimit, imageTaskContentHandler)
...
// route template, so a voice literally named "audio" is not mistaken for the
// /audio suffix.
