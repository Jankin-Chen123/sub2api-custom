...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeySiteLogo:                                  "",
		SettingKeyContactPageQQGroupNumber:                  DefaultContactPageQQGroupNumber,
		SettingKeyContactPageQQQRCodeImage:                  DefaultContactPageQQQRCodeImage,
		SettingKeyContactPageTelegramName:                   DefaultContactPageTelegramName,
		SettingKeyContactPageTelegramURL:                    DefaultContactPageTelegramURL,
		SettingKeyContactPageTelegramQRImage:                DefaultContactPageTelegramQRImage,
		...
		SettingKeyChannelMonitorHealthMode:             string(ChannelMonitorHealthGateOff),
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		ContactPageQQGroupNumber:               contactPageSettingValue(settings, SettingKeyContactPageQQGroupNumber, DefaultContactPageQQGroupNumber),
		ContactPageQQQRCodeImage:               contactPageSettingValue(settings, SettingKeyContactPageQQQRCodeImage, DefaultContactPageQQQRCodeImage),
		ContactPageTelegramName:                contactPageSettingValue(settings, SettingKeyContactPageTelegramName, DefaultContactPageTelegramName),
		ContactPageTelegramURL:                 contactPageSettingValue(settings, SettingKeyContactPageTelegramURL, DefaultContactPageTelegramURL),
		ContactPageTelegramQRImage:             contactPageSettingValue(settings, SettingKeyContactPageTelegramQRImage, DefaultContactPageTelegramQRImage),
	...
	result.ChannelMonitorHealthMode = string(normalizeChannelMonitorHealthMode(settings[SettingKeyChannelMonitorHealthMode]))
