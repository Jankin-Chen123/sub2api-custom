...
const (
	...
	// legacy account rows. Scheduling thresholds never pause Kiro accounts.
	PlatformKiro = "kiro"
)
...
// AllowedSchedulingThresholdPlatforms are the platforms with native usage
// windows that support account auto-pausing thresholds.
...
const (
	...
	SettingKeyAffiliateRedeemAutoValidAmounts     = "affiliate_redeem_auto_valid_amounts"    // 自动计入返利的兑换码面值（JSON 数组）
	SettingKeyAffiliateRedeemAutoExcludedAmounts  = "affiliate_redeem_auto_excluded_amounts" // 自动排除返利的兑换码面值（JSON 数组）
	...
	SettingKeyContactPageQQGroupNumber    = "contact_page_qq_group_number"   // 联系页 QQ 群号
	SettingKeyContactPageQQQRCodeImage    = "contact_page_qq_qr_image"       // 联系页 QQ 群二维码
	SettingKeyContactPageTelegramName     = "contact_page_telegram_name"     // 联系页 Telegram 频道名称
	SettingKeyContactPageTelegramURL      = "contact_page_telegram_url"      // 联系页 Telegram 频道链接
	SettingKeyContactPageTelegramQRImage  = "contact_page_telegram_qr_image" // 联系页 Telegram 二维码
	...
	// request models and built-in Grok aliases.
	SettingKeyGrokDefaultTextModel = "grok_default_text_model"
	// SettingKeyGrokCrossClientModelMapEnabled controls cross-vendor wildcard
	// mappings on Grok accounts.
	SettingKeyGrokCrossClientModelMapEnabled = "grok_cross_client_model_map_enabled"
	// SettingKeyGrokDefaultBaseURLMode controls the default Grok upstream region.
	SettingKeyGrokDefaultBaseURLMode = "grok_default_base_url_mode"
	// SettingKeyAccountSchedulingThresholds stores per-platform auto-pause thresholds.
