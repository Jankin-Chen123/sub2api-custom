...
func init() {
	...
	// imagegenerationjobDescDisplayName is the schema descriptor for display_name field.
	imagegenerationjobDescDisplayName := imagegenerationjobFields[11].Descriptor()
	// imagegenerationjob.DisplayNameValidator is a validator for the "display_name" field. It is called by the builders before save.
	imagegenerationjob.DisplayNameValidator = imagegenerationjobDescDisplayName.Validators[0].(func(string) error)
	// imagegenerationjobDescUpstreamModel is the schema descriptor for upstream_model field.
	imagegenerationjobDescUpstreamModel := imagegenerationjobFields[12].Descriptor()
	...
	imagegenerationjobDescRequestedSize := imagegenerationjobFields[13].Descriptor()
	...
	imagegenerationjobDescActualSize := imagegenerationjobFields[14].Descriptor()
	...
	imagegenerationjobDescQuality := imagegenerationjobFields[15].Descriptor()
	...
	imagegenerationjobDescResponseFormat := imagegenerationjobFields[16].Descriptor()
	...
	imagegenerationjobDescUpstreamTaskID := imagegenerationjobFields[17].Descriptor()
	...
	imagegenerationjobDescIdempotencyKey := imagegenerationjobFields[18].Descriptor()
	...
	imagegenerationjobDescRequestHash := imagegenerationjobFields[19].Descriptor()
	...
	imagegenerationjobDescPromptHash := imagegenerationjobFields[20].Descriptor()
	...
	imagegenerationjobDescPayloadObjectRef := imagegenerationjobFields[21].Descriptor()
	...
	imagegenerationjobDescResultObjectRefs := imagegenerationjobFields[22].Descriptor()
	...
	imagegenerationjobDescBaseCost := imagegenerationjobFields[23].Descriptor()
	...
	imagegenerationjobDescRateMultiplier := imagegenerationjobFields[24].Descriptor()
	...
	imagegenerationjobDescEstimatedCost := imagegenerationjobFields[25].Descriptor()
	...
	imagegenerationjobDescHeldCost := imagegenerationjobFields[26].Descriptor()
	...
	imagegenerationjobDescSettledCost := imagegenerationjobFields[27].Descriptor()
	...
	imagegenerationjobDescErrorCode := imagegenerationjobFields[28].Descriptor()
	...
	imagegenerationjobDescAttemptCount := imagegenerationjobFields[30].Descriptor()
	...
	imagegenerationjobDescClaimVersion := imagegenerationjobFields[31].Descriptor()
	...
	imagegenerationjobDescCreatedAt := imagegenerationjobFields[34].Descriptor()
	...
	imagegenerationjobDescUpdatedAt := imagegenerationjobFields[35].Descriptor()
	...
	// redeemcodeDescAffiliateRebateStatus is the schema descriptor for affiliate_rebate_status field.
	redeemcodeDescAffiliateRebateStatus := redeemcodeFields[4].Descriptor()
	// redeemcode.DefaultAffiliateRebateStatus holds the default value on creation for the affiliate_rebate_status field.
	redeemcode.DefaultAffiliateRebateStatus = redeemcodeDescAffiliateRebateStatus.Default.(string)
	// redeemcode.AffiliateRebateStatusValidator is a validator for the "affiliate_rebate_status" field. It is called by the builders before save.
	redeemcode.AffiliateRebateStatusValidator = redeemcodeDescAffiliateRebateStatus.Validators[0].(func(string) error)
	...
	usersubscriptionDescValidityDays := usersubscriptionFields[4].Descriptor()
